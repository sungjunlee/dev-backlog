...
- **backlog-triage scripts-less experiment** — a 33-line variant B SKILL.md (`gh` reads, fixed report shape, anchors, `triage-apply.js` kept) matches the current SKILL.md + scripts on all seven `tests/evals/backlog-triage.md` scenarios on Claude Fable 5.1 and GPT-6 Astra at plan level (`docs/conformance/2026-09-17-triage-scriptless.md`); deletion of collect/relate/stale/report filed as #433, gated on one real-execution A/B. Closes [#427](https://github.com/sungjunlee/dev-backlog/issues/427); closes the last #367 item.
