...
- `scripts/setup-dev-backlog.js [project-name] [--tracker github|files|gitlab] [--non-interactive] [--json]` — persist the chosen task authority (`github`, `files`, or `gitlab`) and create only `sprints/`.
