...
| `backlog/tasks/*.md` | Leftover operator / Backlog.md tree. The skill does not write here and never treats it as execution or runtime authority. | Backlog.md / operator |
...
- `backlog/tasks/*.md` is leftover operator or Backlog.md files. The skill does not write there and never uses it as execution or runtime authority.
