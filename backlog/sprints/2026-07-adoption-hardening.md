...
- [x] #260 docs(dev-backlog): compress reassess accounting to one sentence + pointer (C2) (~20min) — 3-sentence paragraph → 2 sentences; accounting stays in integration-contract; unattended rule preserved
- [x] #261 feat(dev-backlog): checkbox-repair runbook and doctor message link (C3) (~30min) — references/checkbox-repair.md (detect→repair); doctor unmoored warn names it; test asserts the link; **E4 complete.**
