...
- [ ] #381 Retire proof-only living docs after the #350 closeout (~2h)
...
- README no longer points at `docs/compatibility-subtraction.md` (#369). #381 retires remaining proof-only Living docs.
